...
import { TbTrophy, TbEye, TbHeart, TbCalendar, TbBolt, TbLock, TbClock, TbDeviceGamepad2, TbBookmarks, TbThumbUp, TbHistory, TbInfoCircle } from 'react-icons/tb';
                ...
                >
                    ...
                    {activeTab === 'Library' && (
                        profileData.libraryGames && profileData.libraryGames.length > 0 
                            ...
                            : <EmptyState icon={TbDeviceGamepad2} title={t('Library')} desc={t('Keep exploring to unlock more Badges!')} />
                    )}
